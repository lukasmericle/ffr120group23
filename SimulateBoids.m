...
for i = 2:simStats.stepCount
    ...
    preyBoidStats.dx(:,i) = simStats.deltaT*cos(preyBoidStats.v(:,i));
    preyBoidStats.dy(:,i) = simStats.deltaT*sin(preyBoidStats.v(:,i));
    ...
    predatorBoidStats.dx(:,i) = simStats.deltaT*cos(predatorBoidStats.v(:,i));
    predatorBoidStats.dy(:,i) = simStats.deltaT*sin(predatorBoidStats.v(:,i));
